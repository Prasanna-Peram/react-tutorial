                ...
                <table className="table table-hover caption-top">
                    ...
                    <thead>
                                            ...
                                            <dl>
                                                {
                                                    props.fields.map(field=>
                                                        <div key={field}>
                                                            <dt >{field}:</dt>
                                                            <dd><input type="text" for={field} name={field}></input></dd>
                                                        </div>
                                                    )
                                                }
                                            </dl>
                        ...
                        <tr>
                            {
                                props.fields.map(field=>
                                    <th key={field}>{field}<div className="dropdown d-inline"> <button data-bs-toggle="dropdown" data-bs-target="#menu" className="btn dropdown-toggle" ></button> <ul className="dropdown-menu" id="menu"> <li className="dropdown-item"> <span className="bi bi-sort-alpha-down"></span> Sort Ascending </li> <li className="dropdown-item"> <span className="bi bi-sort-alpha-up"></span> Sort Descending </li> </ul> </div>
                                    </th>
                                )
                            }
                             <th>Actions</th>
