            ...
            <BrowserRouter>
                <header style={{height:'150px'}} className="d-flex justify-content-around p-3 bg-dark text-white">
                    <div className="profile-pic">
                      <img className="profile-pic" src="developer.jpg" width="100" height="100" alt=""/>
                      <h4>John</h4>
                    </div>
                    <div>
                ...
                <section className="bg-secondary text-white p-3" style={{height:'100vh'}}>
                    <Routes>
                        <Route path="/" element={<div><h2>UI/UX Developer</h2><p>HTML | CSS | Javascript | Reacts</p></div>}></Route>
